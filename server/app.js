...
{
    request('http://api.openweathermap.org/data/2.5/weather?q=Olland,NL&units=metric&APPID=af4e90c5fa4b97bc975f49656739adaf', function(error, response, body){
        console.log("getWeatherToday request " + error + ' - '  + body);
        var jsonBody = JSON.parse(body);
        var temperature = jsonBody.main.temp;
